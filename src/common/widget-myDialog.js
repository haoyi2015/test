	(function(win, doc){
		...
		**/
		function _confirmOrder(str){
			...
			that.TPL = '<div class="widget_wrap" style="z-index:{zIndex2};" >\
				...
				<div class="widget_footer">\
					<ul>\
						<li><button type="button">取消订单</button></li>\
						<li><button type="button">继续确认</button></li>\
					</ul>\
				</div>\
			</div>';
			that.type = "confirm";
		...
		_confirmOrder.prototype = new _dialog();
		_confirmOrder.prototype.constructor = _confirmOrder;
		...
		**/
		...
		win.confirmOrder = function(str, args){return new _confirmOrder(str, args).config(args).open();};
